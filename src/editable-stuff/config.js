...
const mainBody = {
  ...
  middleName: "",
  lastName: "Chu",
  message: " Web Developer | Kinesiologist | Powerlifter | Avid Reader ",
  icons: [
    {
      image: "fa-github",
...
const about = {
  show: true,
  heading: "About Me",
  imageLink: require("../editable-stuff/kevin-bio.png"),
  imageSize: 275,
...
const repos = {
  ...
  reposLength: 0,
  specificRepos: ["buy-sell-app", "GitGood", "jungle-rails", "tinyapp"],
};
